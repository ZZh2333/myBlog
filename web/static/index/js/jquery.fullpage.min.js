...
function(e, n, t, o, i) {
	...
	e.fn.fullpage = function(l) {
		...
		function se() {
			...
			n.length && We(n, null, !0)
		}
		function ce() {
			var n = e(b).next(y);
			n.length || !l.loopBottom && !l.continuousVertical || (n = e(y).first()),
			n.length && We(n, null, !1)
		}
		function de(e, n) {
			Q(0, "internal"),
			fe(e, n),
			Q(At.scrollingSpeed, "internal")
		}
		function fe(e, n) {
			var t = Rn(e);
		...
		function pe(n) {
			if (!mt.hasClass(f)) {
				...
				e(y).each(function() {
					var n = e(this).find(q),
					t = e(this).find(z);
					l.verticalCentered && e(this).find(k).css("height", Hn(e(this)) + "px"),
					e(this).css("height", gt + "px"),
					l.scrollOverflow && (t.length ? t.each(function() {
						Mn(e(this))
					}) : Mn(e(this))),
					t.length > 1 && gn(n, n.find(D))
				});
				var t = e(b),
				o = t.index(y);
				o && de(o + 1),
				wt = !1,
				e.isFunction(l.afterResize) && n && l.afterResize.call(mt),
				e.isFunction(l.afterReBuild) && !n && l.afterReBuild.call(mt)
			}
		}
		function ve(n) {
			var t = st.hasClass(c);
		...
		function ge() {
			...
			var n = e(b).find(D);
			n.length && (0 !== e(b).index(y) || 0 === e(b).index(y) && 0 !== n.index()) && $n(n),
			xn(),
			Yn(),
			"complete" === t.readyState && on(),
			ne.on("load", on)
		}
		function we() {
			ne.on("scroll", He).on("hashchange", an).blur(un).resize(bn),
			te.keydown(rn).keyup(sn).on("click touchstart", A + " a", hn).on("click touchstart", U, pn).on("click", O, ln),
			e(y).on("click touchstart", W, fn),
		...
		function ye() {
			...
			e(y).each(function(n) {
				...
				xe(t, n),
				Ce(t, n),
				i > 0 ? be(t, o, i) : l.verticalCentered && On(t)
			}),
			l.fixedElements && l.css3 && e(l.fixedElements).appendTo(st),
			l.navigation && Ie(),
			Ee(),
			l.scrollOverflow ? ("complete" === t.readyState && Le(), ne.on("load", Le)) : Oe()
		}
		function be(n, t, o) {
			var i = 100 * o,
			a = 100 / o;
		...
		function Ce(n, t) {
			"undefined" != typeof l.anchors[t] && n.hasClass(p) && Ln(l.anchors[t], t),
			l.menu && l.css3 && e(l.menu).closest(r).length && e(l.menu).appendTo(st)
		}
		function Te() {
			mt.find(l.sectionSelector).addClass(S),
			mt.find(l.slideSelector).addClass(R)
		}
		function ke(e) {
		...
		function Ie() {
			...
			for (var t = 0; t < e(y).length; t++) {
				...
				"undefined" != typeof a && "" !== a && (i += '<div class="' + M + " " + l.navigationPosition + '">' + a + "</div>"),
				i += "</li>",
				n.find("ul").append(i)
			}
		...
		function Oe() {
			...
			e.isFunction(l.afterRender) && l.afterRender.call(mt)
		}
		function He() {
			var n;
			if (!l.autoScrolling || l.scrollBar) {
				...
				if (s) a = c.length - 1;
				else if (o) for (var d = 0; d < c.length; ++d) {
					var f = c[d];
					f.offsetTop <= r && (a = d)
				} else a = 0;
				if (Be(i) && (e(b).hasClass(m) || e(b).addClass(m).siblings().removeClass(m)), n = e(c).eq(a), !n.hasClass(p)) {
					...
					yt && (n.addClass(p).siblings().removeClass(p), e.isFunction(l.onLeave) && l.onLeave.call(v, g, x, w), e.isFunction(l.afterLoad) && l.afterLoad.call(n, S, x), nn(v), $e(n), _e(n), Ln(S, x - 1), l.anchors.length && (dt = S), Fn(u, h, S, x)),
					clearTimeout(It),
		...
		function Pe(n) {
			...
			if (!qe(n.target) && Fe(t)) {
				...
				if (yt && !ht) {
					...
					Rt = r.y,
					zt = r.x,
					i.find(q).length && o.abs(Bt - zt) > o.abs(Ht - Rt) ? o.abs(Bt - zt) > ne.outerWidth() / 100 * l.touchSensitivity && (Bt > zt ? xt.m.right && ue(i) : xt.m.left && he(i)) : l.autoScrolling && o.abs(Ht - Rt) > ne.height() / 100 * l.touchSensitivity && (Ht > Rt ? ze("down", a) : Rt > Ht && ze("up", a))
				}
			}
		}
		function qe(n, t) {
		...
		function je(e, n) {
			for (var t = 0,
			i = e.slice(o.max(e.length - n, 1)), a = 0; a < i.length; a++) t += i[a];
			return o.ceil(t / n)
		}
		function Ye(t) {
		...
		function Xe(e) {
			...
			return e.outerHeight() > gt ? (o || a) && "bottom" !== a || (t = i) : (o || wt && e.is(":last-child")) && (t = i),
			Pt = t,
			t
		}
		function We(n, t, o) {
		...
		function Ke(n) {
			if (l.css3 && l.autoScrolling && !l.scrollBar) {
				...
				Bn(t, !0),
				l.scrollingSpeed ? (clearTimeout(Tt), Tt = setTimeout(function() {
					Ze(n)
				},
		...
		function mn(e) {
			yt && (e.pageY < qt && xt.m.up ? se() : e.pageY > qt && xt.m.down && ce()),
			qt = e.pageY
		}
		function gn(n, t, o) {
			var i = n.closest(y),
			...
			return a.xMovement = An(a.prevSlideIndex, a.slideIndex),
			a.localIsResizing || (yt = !1),
			l.onSlideLeave && !a.localIsResizing && "none" !== a.xMovement && e.isFunction(l.onSlideLeave) && l.onSlideLeave.call(a.prevSlide, a.anchorLink, a.sectionIndex + 1, a.prevSlideIndex, a.xMovement, a.slideIndex) === !1 ? void(ht = !1) : (t.addClass(p).siblings().removeClass(p), a.localIsResizing || (nn(a.prevSlide), $e(t)), !l.loopHorizontal && l.controlArrows && (i.find(J).toggle(0 !== a.slideIndex), i.find(ee).toggle(!t.is(":last-child"))), i.hasClass(p) && Fn(a.slideIndex, a.slideAnchor, a.anchorLink, a.sectionIndex), void Sn(n, a, !0))
		}
		function wn(n) {
			yn(n.slidesNav, n.slideIndex),
			n.localIsResizing || (e.isFunction(l.afterSlideLoad) && l.afterSlideLoad.call(n.destiny, n.anchorLink, n.sectionIndex + 1, n.slideAnchor, n.slideIndex), yt = !0),
			_e(n.destiny),
			ht = !1
		}
		function Sn(e, n, t) {
		...
		function Mn(e) {
			if (!e.hasClass("fp-noscroll")) {
				...
				n > r ? a.length ? t.update(e, r) : (l.verticalCentered ? e.find(k).wrapInner(o) : e.wrapInner(o), t.create(e, r)) : t.remove(e),
				e.css("overflow", "")
			}
		}
		function On(e) {
		...
		function zn(e, n) {
			...
			return o.length || (o = t.find(z).eq(e)),
			o
		}
		function Dn(e, n) {
			var t = Rn(e);
			t.length && ("undefined" == typeof n && (n = 0), e === dt || t.hasClass(p) ? Pn(t, n) : We(t,
			function() {
				Pn(t, n)
			}))
		}
		...
		function Fn(e, n, t, o) {
			var i = "";
			l.anchors.length && !l.lockAnchors && (e ? ("undefined" != typeof t && (i = t), "undefined" == typeof n && (n = e), ft = n, Vn(i + "/" + n)) : "undefined" != typeof e ? (ft = n, Vn(t)) : Vn(t)),
			Yn()
		}
		function Vn(e) {
		...
		function Qn() {
			if (l.autoScrolling && (pt || vt)) {
				var n = Jn();
				st.off("touchmove " + n.move).on("touchmove " + n.move, De),
				e(r).off("touchstart " + n.down).on("touchstart " + n.down, Ve).off("touchmove " + n.move).on("touchmove " + n.move, Pe)
			}
		}
		function Gn() {
			if (pt || vt) {
		...
		function Zn(e) {
			...
			vt && Fe(e) && l.scrollBar && (n.y = e.touches[0].pageY, n.x = e.touches[0].pageX),
			n
		}
		function $n(e, n) {
			Q(0, "internal"),
		...
		function tt(n) {
			...
			clearTimeout(It),
			clearTimeout(Lt),
			ne.off("scroll", He).off("hashchange", an).off("resize", bn),
			te.off("click touchstart", A + " a").off("mouseenter", A + " li").off("mouseleave", A + " li").off("click touchstart", U).off("mouseover", l.normalScrollElements).off("mouseout", l.normalScrollElements),
			e(y).off("click touchstart", W),
			clearTimeout(kt),
			clearTimeout(Tt),
			n && ot()
		}
		function ot() {
			_n(0),
			mt.find("img[data-src], source[data-src], audio[data-src], iframe[data-src]").each(function() {
			...
			st.removeClass(c),
			e.each(st.get(0).className.split(/\s+/),
			function(e, n) {
		...
		xt.k = e.extend(!0, {},
		xt.m);
		var Ct, Tt, kt, It, Lt, Et, At = e.extend(!0, {},
		l);
		at(),
		oe.click = vt,
